...
def user_avatar(user, display_name = True, popover_target_name = None):
  ...
  return { 'url': f"{BASE_URL}/{email_hash.hexdigest()}", 'username': user.username.capitalize(), 'display_name': display_name, 'popovertargetname': popover_target_name }